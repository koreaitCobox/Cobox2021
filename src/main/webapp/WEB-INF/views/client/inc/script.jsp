...
<script>window.jQuery || document.write('<script src="/resources/js/external/jquery-3.1.1.min.js"><\/script>')</script>
<!-- Migrate --> 
...
<!-- Knob js -->
<script src="/resources/js/external/jquery.knob.js"></script>
<!-- Count comimg soon -->
<script src="/resources/js/external/count.down.js"></script>
<!-- Magnific-popup -->
